...
async def analyze_text(event: Message, state: FSMContext):
    ...
    await event.reply(f'<b>Стастистика по тексту:</b>\n'
                      ...
                      f'<b>Слов в предложении:</b> {round(analysis.words_per_sentence, 2)}\n'
                      f'<b>Предлогов:</b> {analysis.prepositions}\n'
                      f'<b>Местоимений:</b> {analysis.articles}\n'
                      f'<b>Букв в предложении:</b> {round(analysis.letters_per_sentence, 2)}\n'
                      ...
                      f'<b>Слов между запятыми:</b> {round(analysis.words_between_pauses, 2)}\n'
                      f'<b>Запятых в предложении:</b> {round(analysis.pauses_per_sentence, 2)}\n'
